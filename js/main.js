(() => {
  ...
  //     description:
  //       "Comfortable Rubber is a silicon material that helps to keep the earbuds in the ear and at the same time it feels very comfortable and prevents them from falling.",
  //   },
  //   {
